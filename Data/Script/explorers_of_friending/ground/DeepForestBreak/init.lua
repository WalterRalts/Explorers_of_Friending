...
function DeepForestBreak.ZoomUp(map)
  ...
  TASK:JoinCoroutines({coro11, coro22})
  ...
  local coro1 = TASK:BranchCoroutine(function() 
    UI:SetSpeaker(zoomer)
    UI:SetSpeakerEmotion("Angry")
    UI:WaitShowTimedDialogue("He sends me out here[pause=40] for some dumb recruits!", 60)
    UI:SetSpeakerEmotion("Happy")
    UI:WaitShowTimedDialogue("'Do not worry, they will be there in a moment!'", 60)
    UI:SetSpeakerEmotion("Angry")
    UI:WaitShowTimedDialogue("I'm here, and they aren't ah-")
    GROUND:CharAnimateTurnTo(zoomer, Dir8.Down, 2)
