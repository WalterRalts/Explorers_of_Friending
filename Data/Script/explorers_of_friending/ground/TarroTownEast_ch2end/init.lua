...
function TarroTownEast_ch2end.WentWhere()
 ...
 EXPLCOMMON.CharSweating("Ziggy")
  ...
  UI:SetSpeaker(ziggy)
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue("And there were, like, five more of them hurting the tree!")
 EXPLCOMMON.CharHop("Ziggy")
  UI:SetSpeakerEmotion("Angry")
  UI:WaitShowDialogue("We had to fight them!")

 EXPLCOMMON.CharQuestion("Beel")
  UI:SetSpeaker(furie)
  UI:SetSpeakerEmotion("Surprised")
 ...
 EXPLCOMMON.FaceEachother(arama, furie)
  UI:SetSpeaker(arama)
  UI:SetSpeakerEmotion("Worried")
 ...
 EXPLCOMMON.CharAngry("Arama")
  ...
  local b1 = TASK:BranchCoroutine(function()
    UI:SetSpeaker(beel)
    UI:SetSpeakerEmotion("Normal")
    UI:WaitShowDialogue("Arama, you shouldn't underestimate them just because they're kids...")
    UI:WaitShowDialogue("Right, Amazuru?")
    end)
  TASK:JoinCoroutines({a1, b1})

  GROUND:CharTurnToCharAnimated(amazuru, ziggy, 4)
  EXPLCOMMON.CharSweatdrop("Amazuru")
  UI:SetSpeaker(amazuru)
  UI:SetSpeakerEmotion("Pain")
  UI:WaitShowDialogue("Oh, no,[pause=30] don't remind me...")
  ...
  local coro01 = TASK:BranchCoroutine(function()
    GROUND:CharAnimateTurnTo(azura, Direction.Left, 5)
    GROUND:CharAnimateTurnTo(maru, Direction.Left, 4)
    GROUND:CharAnimateTurnTo(puchi, Direction.Left, 2)
    GROUND:CharAnimateTurnTo(senna, Direction.Left, 2)
    GROUND:CharAnimateTurnTo(ziggy, Direction.Left, 8)
    end)
  local coro02 = TASK:BranchCoroutine(function()
    GROUND:CharAnimateTurnTo(arama, Direction.Left, 5)
    GROUND:CharAnimateTurnTo(amazuru, Direction.Left, 5)
