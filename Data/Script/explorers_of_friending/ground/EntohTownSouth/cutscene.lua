...
function South.BossBegin()
   ...
   EXPLCOMMON.TeleportToMarker(wurp, "move_3", Dir8.Up)
   ...
   EXPLCOMMON.FaceEachother(snow, wurp)
   EXPLCOMMON.CharAngry("Wurp")
    UI:SetSpeaker(wurp)
    UI:SetSpeakerEmotion("Angry")
    UI:WaitShowDialogue("And wat does that mean?!")

    if SV.Story.flag == 0 then -- Neither of them were found
       ...
       EXPLCOMMON.FaceEachother(rexio, wurp)
    ...
    elseif SV.Story.flag[1] == "Flow" and SV.Story.flag[2] == 0 then -- Flow was found
    ...
    elseif SV.Story.flag[1] == "Tidy" and SV.Story.flag[2] == 0 then --Tidy was found
        local tidy = CH('Teammate1')
        local rexio = CH("PLAYER")
        GROUND:MoveToPosition(tidy, 145, 164, true, 4)
        GROUND:MoveToPosition(rexio, wurp.Position.X - 45, wurp.Position.Y, false, 2)
        UI:SetSpeaker(rexio)
        UI:SetSpeakerEmotion("Surprised")
        UI:WaitShowDialogue("Ah! Someone else!")
       ...
       EXPLCOMMON.CharHop("PLAYER")
        ...
        local coro4 = TASK:BranchCoroutine(function()
            ...
            UI:SetSpeaker(snow)
            UI:SetSpeakerEmotion("Sad")
            UI:WaitShowTimedDialogue("I know,[pause=20] b-but this isn't... in my control kinda...", 45)
       ...
       EXPLCOMMON.FaceEachother(a4, snow)
       EXPLCOMMON.CharExclaim("Snow")
        UI:SetSpeaker(snow)
        UI:SetSpeakerEmotion("Surprised")
        UI:WaitShowDialogue("I-isn't that a-[pause=20]a little hasty...?")
        ...
        UI:SetSpeaker(rexio)
        UI:SetSpeakerEmotion("Sigh")
        UI:WaitShowDialogue("...[pause=25]let's just get this over with.[pause=10[emote=Determined] Out of our way.")
    else
        local rexio = CH("PLAYER")
        local tidy = CH('Teammate1')
       ...
       EXPLCOMMON.CharHop("PLAYER")
        ...
        local coro3 = TASK:BranchCoroutine(function()
            GAME:WaitFrames(50)
            GROUND:CharAnimateTurn(snow, Dir8.UpLeft, 6, true)
            end)
        local coro4 = TASK:BranchCoroutine(function()
            GAME:WaitFrames(20)
            UI:SetSpeaker(snow)
       ...
       EXPLCOMMON.FaceEachother(flow, tidy)
       ...
       EXPLCOMMON.FaceEachother(flow, snow)
       EXPLCOMMON.FaceEachother(tidy, snow)
        ...
        UI:SetSpeaker(rexio)
        UI:SetSpeakerEmotion("Normal")
        UI:WaitShowTimedDialogue("But it sucks cuz it's-")
        ...
        EXPLCOMMON.FaceEachother(tidy, a2)
        EXPLCOMMON.FaceEachother(flow, a1)
        EXPLCOMMON.FaceEachother(rexio, a2)
        GAME:WaitFrames(70)
