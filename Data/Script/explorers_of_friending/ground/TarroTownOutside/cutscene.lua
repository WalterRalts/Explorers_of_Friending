...
function Outside.CloudWatch()
  if SV.tarro_town.PieChapter >= 0 then
    ...
    UI:WaitShowTitle("Prologue A-1", 180)
    GAME:WaitFrames(30)
    UI:WaitHideTitle(180)

    UI:SetSpeaker(maru)
    UI:SetSpeakerEmotion("Normal")
    UI:WaitShowDialogue("It's...[pause=40] relaxing.[pause=0] Sitting here, watching the clouds go by...")
    UI:WaitShowDialogue("We should really do this more often.")
