...
function Bluetails.RealPieTime()
    ...
    UI:WaitShowDialogue("Besides, you already impress them with your battle skills.[pause=20] I'll impress their stomachs.")
...
function Bluetails.AfterPieTime()
 ...
 EXPLCOMMON.FaceEachother(arama, amazuru)
  ...
  GAME:FadeOut(false, 30)
  GROUND:TeleportTo(maru, 221, 240, Direction.Left, 0)
