...
function MaruHome.PieTime()
  ...
  UI:SetSpeaker(amazuru)
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue("All they have to do is avoid the wild bugs, they're all weak. Plenty of Big Apples there, too.")
  ...
  UI:SetSpeaker(arama)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue("...[pause=34] ...[pause=34] ...[pause=34]f[emote=Sigh]ine.")
  UI:SetSpeakerEmotion("Stunned")
...
function MaruHome.AfterPieTime()
  ...
  GROUND:CharAnimateTurn(amazuru, Direction.DownRight, 4, false)
  ...
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowTimedDialogue("Well,[pause=40] yes, but there's something impo-", 50)
  ...
  GROUND:CharTurnToCharAnimated(amazuru, ziggy, 2)
  ...
  UI:SetSpeaker(ziggy)
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue("Yep![pause=0] They're more serious this time, so hurry up, they might start shooting lightning and stuff.")

  GROUND:MoveToPosition(ziggy, 200, 346, false, 10)
  GAME:WaitFrames(65)
  UI:SetSpeaker(arama)
  UI:SetSpeakerEmotion("Stunned")
  UI:WaitShowDialogue("Maybe we should invest in a door...")
