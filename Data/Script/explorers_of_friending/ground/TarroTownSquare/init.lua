...
function TarroTownSquare.FightFightFight()
    ...
    UI:SetSpeaker(plus)
    UI:SetSpeakerEmotion("Angry")
    local coro1 = TASK:BranchCoroutine(function() GAME:WaitFrames(24)
      GROUND:MoveToPosition(puchi, 1636, 292, false, 1)
      GROUND:CharTurnToCharAnimated(puchi, plus, 7)
      end)	
    local coro2 = TASK:BranchCoroutine(function() UI:WaitShowDialogue("What does that even mean?!")
      end)
    ...
    UI:WaitShowDialogue("Pouch? What are you doing here?", GROUND:CharTurnToCharAnimated(puchi, gepii, 5))
    ...
    local coro7 = TASK:BranchCoroutine(function() GROUND:MoveToPosition(maru, 1706, 280, false, 4)
      end)
    ...
    UI:SetSpeakerEmotion("Determined")
    UI:WaitShowTimedDialogue("Yeah!", 60)
    ...
    UI:SetSpeaker(happy)
    UI:SetSpeakerEmotion("Sigh")
    UI:WaitShowDialogue("I'm done...[pause=45] [script=0]glad I didn't prepare for this.")
