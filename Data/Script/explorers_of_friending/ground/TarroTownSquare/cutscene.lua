...
function Square.FightFightFight()
  ...
  local coro9 = TASK:BranchCoroutine(function()
      GROUND:MoveToPosition(kek, 1000, 250, false, 4)
      end)
  ...
  local function followhaps()
    GAME:WaitFrames(35)
    AI:SetCharacterAI(happy, "origin.ai.ground_partner", CH('Happy'), happy.Position)
  end
  UI:SetSpeaker(gepii)
  UI:SetSpeakerEmotion("Shouting")
...
GROUND:TeleportTo(gepii, 1304, 196, Direction.Right)
  ...
  local coro16 = TASK:BranchCoroutine(function() GAME:WaitFrames(24)
      UI:SetSpeaker(getic)
      UI:SetSpeakerEmotion("Stunned")
