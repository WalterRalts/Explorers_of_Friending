...
function Square.FightFightFight()
  ...
  local coro8 = TASK:BranchCoroutine(function() GAME:WaitFrames(24)
    ...
    local coro08 = TASK:BranchCoroutine(function() 
      ...
      GAME:WaitFrames(35)
      GROUND:MoveToPosition(gepii, 1200, 278, false, 5)
      end)	
    local coro09 = TASK:BranchCoroutine(function()
      GAME:WaitFrames(90)
      GROUND:MoveToPosition(happy, 1000, 279, false, 2)      
      end)

    TASK:JoinCoroutines({coro08, coro09})
    end)	
  local coro9 = TASK:BranchCoroutine(function()
    GROUND:MoveToPosition(kek, 1700, 278, false, 2)
    GROUND:MoveToPosition(kek, 1000, 278, false, 4)
    end)
  ...
  local coro008 = TASK:BranchCoroutine(function() 
      GROUND:MoveToPosition(ziggy, 1650, 250, false, 2)
      GROUND:MoveToPosition(ziggy, 1000, 250, false, 7)
      end)	
  ...
  local coro0008 = TASK:BranchCoroutine(function()
    ...
    GROUND:MoveToPosition(puchi, 1000, 249, false, 3)
...
function Square.AfterQuiz()
  ...
  local coro2 = TASK:BranchCoroutine(function()
    ...
    local coro0001 = TASK:BranchCoroutine(function() 
      GROUND:MoveToPosition(ziggy, 433, 235, false, 2)
      end)
    local coro0002 = TASK:BranchCoroutine(function()
      GROUND:CharSetAnim(ziggy, "Hop", false)
      end)
  
    TASK:JoinCoroutines({coro0001, coro0002})
    end)
