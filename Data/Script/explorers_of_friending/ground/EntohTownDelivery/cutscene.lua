...
function Entoh.Dragon()
    ...
    if SV.entoh_town.thicket.result > -1 and SV.Story.sect == 2 then
        GAME:CutsceneMode(true)
       EXPLCOMMON.FaceEachother(dragon, ponya)
        UI:SetSpeaker(ponya)
       ...
       EXPLCOMMON.FaceEachother(dragon, bucks)
        UI:SetSpeakerEmotion("Worried")
        ...
        local corr2 = TASK:BranchCoroutine(function()
            ...
            UI:SetSpeaker(ponya)
            UI:SetSpeakerEmotion("Angry")
            UI:WaitShowDialogue("Out of his control for[pause=25] THREE[pause=35] WEEKS!")
        end)
        ...
        local coror2 = TASK:BranchCoroutine(function()
           GAME:WaitFrames(55)
          EXPLCOMMON.FaceEachother(mud, ponia)
        end)
        TASK:JoinCoroutines({coror1, coror2})

        
        local coror1 = TASK:BranchCoroutine(function()
           EXPLCOMMON.FaceEachother(ponya, bucks)
