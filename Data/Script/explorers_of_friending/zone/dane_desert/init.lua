--[[
    init.lua
    Created: 10/24/2025 23:41:50
    Description: Autogenerated script file for the map dane_desert.
]]--
...
-- Zone Callbacks
-------------------------------
---dane_desert.Init(zone)
--Engine callback function
function dane_desert.Init(zone)


end

---dane_desert.EnterSegment(zone, rescuing, segmentID, mapID)
--Engine callback function
function dane_desert.EnterSegment(zone, rescuing, segmentID, mapID)


end

---dane_desert.ExitSegment(zone, result, rescue, segmentID, mapID)
--Engine callback function
...
---dane_desert.Rescued(zone, name, mail)
--Engine callback function
function dane_desert.Rescued(zone, name, mail)
